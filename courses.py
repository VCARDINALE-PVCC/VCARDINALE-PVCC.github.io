...
def main():
    ...
    f.close()
    print("To see results open file: " + file_name)
...
def display_network_courses():
    ...
    f.write(" Students choose 3 technical elective courses")
    f.write (dash_line)

def process_info_courses():
    global info_req, info_elect, num_info_req, num_info_elect, tot_info, all_info_courses
    # find the required courses for the Information Technology degree
    info_req = {'CSC 110', 'ENG 111', 'ENG 112', 'ETR 149', 'ETR 164', 'ITD 110', 'ITD 132', 'ITE 182', 'ITE 215', 'ITN 101', 'ITN 106', 'ITN 111', 'ITP 120', 'MTH 131'}

    # find the technical elective courses for the Information Technology degree
...
def display_info_courses():
    ...
    f.write(dash_line)
    f.write("Number of required courses   : " + str(num_info_req))
    f.write("Number of elective courses   : " + str(num_info_elect))
    f.write("Total number of degree courses: " + str(tot_info))
    f.write(dash_line)
    f.write("All degree courses: ")
    num = 1
...
def process_courses_in_both():
    ...
    f.write (dash_line)
    f.write ("REQUIRED courses in both programs: ")
    num = 1
    ...
    f.write("ELECTIVE courses in both programs: ")
    num = 1
